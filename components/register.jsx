...
const Register = () => {
    ...
    const onSubmit = async (values) => {
        try {
            ...
            const twoExperienceDay = differenceInDays(values.experiedEndDateTwo, values.experiedStartDateTwo) + 1;
            const threeExperienceDay = differenceInDays(values.experiedEndDateThree, values.experiedStartDateThree) + 1
            const fourExperienceDay = differenceInDays(values.experiedEndDateFour, values.experiedStartDateFour) + 1
            ...
            formData.append("graduationCourseDuration", values.graduationCourseDuration);
    ...
    return (
        ...
        w-screen min-h-screen flex flex-col justify-center items-center`}>
            <div className="w-4/5 bg-white flex flex-col justify-center items-center
            my-10 rounded-sm min-h-screen border border-gray-300 shadow-md">
                <div className="w-11/12 z-0 relative p-8 my-10  flex flex-col justify-center border border-gray-300 rounded-md">
                    <div className="w-[96%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">Application Form</p></div>
                    <Form {...form}>
                        <form className="py-6" onSubmit={form.handleSubmit(onSubmit)}>
                            <div className="w-11/12 z-0 relative p-8 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">Basic Information</p></div>
                                <FormField
                                    name="role"
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Applicant&apos;s Name <span className="text-red-900 text-sm">*</span></FormLabel>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Father&apos;s Name <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Mother&apos;s Name <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Nationality <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value}>
                                                <FormControl>
                                                    <SelectTrigger>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Religion <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value}>
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Gender <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value}>
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">National ID <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Marrital Status <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value}>
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Blood Group <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Mobile Number <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Home Mobile Number <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Password <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Physical Challenged <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <RadioGroup className="flex flex-row items-center gap-x-10" onValueChange={field.onChange} defaultValue={field.value}>
                                                    <FormItem>
                                                        <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Ethonic Group <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <RadioGroup className="flex flex-row items-center gap-x-10" onValueChange={field.onChange} defaultValue={field.value}>
                                                    <FormItem>
                                                        <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Student Category <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <div className="w-2/3 flex flex-col">
                                                ...
                                                <FormDescription className="text-red-800">Experienced Applicant Must be at least 3 years Experience RMG Sector.
                                                    And describe in experience details form
                                                </FormDescription>
                                                <FormMessage />
                                            </div>
                                        </FormItem>
                            ...
                            <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">Present Address</p></div>
                                <FormField
                                    control={form.control}
                                    name="presentVillage"
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Village/Road/House <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Textarea {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">District <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value}>
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Upazila/Thana <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Post Office <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Post Code <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                            ...
                            <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">Permanent Address</p></div>
                                <FormField
                            ...
                            <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">Home Address</p></div>
                                <FormField
                                    name="homeVillage"
                                    control={form.control}
                                    render={({ field }) => (
                            ...
                            <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">SSC/Equivalent Level</p></div>
                                <FormField
                                    name="sscExamName"
                                    control={form.control}
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Examination <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="equivalent">S.S.C Equivalent</SelectItem>
                                                </SelectContent>
                                            </Select>
                                            <FormMessage />
                                        </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Board <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="bteb">Bangladesh Technical Education Board</SelectItem>
                                                    <SelectItem value="other">Other</SelectItem>
                                                </SelectContent>
                                            </Select>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Roll No <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">SSC Result <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <div className="w-2/3">
                                                <FormControl>
                                                    <Input type="text" placeholder="Division or GPA" {...field} />
                                                </FormControl>
                                                <FormDescription className="text-red-800 text-xs">Enter your result here (1st Division, 2nd Division, GPA minimum 3 point)</FormDescription>
                                            </div>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Group/Subject <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Passing Year <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                            ...
                            <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">HSC/Equivalent Level</p></div>
                                <FormField
                                    control={form.control}
                                    name="hseExamName"
                                    render={({ field }) => (
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">HSC Result <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <div className="w-2/3">
                                                <FormControl>
                                                    <Input type="text" placeholder="Division or GPA" {...field} />
                                                </FormControl>
                                                <FormDescription className="text-red-800 text-xs">Enter your result here (1st Division, 2nd Division, GPA minimum 3)</FormDescription>
                                            </div>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                        ...
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            ...
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="machatronics">Machatronics</SelectItem>
                            ...
                            <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">Graduation/Equivalent Level</p></div>
                                <FormField
                                    control={form.control}
                                    name="graduationName"
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            ...
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="bscEng">B.Sc Engineering</SelectItem>
                                                    ...
                                                    <SelectItem value="graduationEquivalent"> Graduation Equivalent</SelectItem>
                                                </SelectContent>
                                            </Select>
                                            <FormMessage />
                                        </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Subject/Degree <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Univerisy/Institute <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right"> Result <span className="text-red-900 text-sm">*</span></FormLabel>
                                            <div className="w-2/3">
                                                <FormControl>
                                                    <Input type="text" placeholder="Division or GPA" {...field} />
                                                </FormControl>
                                                <FormDescription className="text-red-800 text-xs">Enter your result here (1st Division, 2nd Division, GPA minimum 2.5)</FormDescription>
                                            </div>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Course Duration <span className="text-red-900 text-xs">*</span></FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                            ...
                            <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">Masters/Equivalent Level</p></div>
                                <FormField
                                    control={form.control}
                                    name="masterName"
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Examination</FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="masterEquivalent"> Master Equivalent</SelectItem>
                                                </SelectContent>
                                            </Select>
                                            <FormMessage />
                                        </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Subject/Degree</FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/3 text-right">Univerisy/Institute</FormLabel>
                                            <FormControl className="w-2/3">
                                                <Input type="text" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Passing Year</FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                            <FormLabel className="w-1/2 text-right">Course Duration</FormLabel>
                                            <Select className="w-1/2" onValueChange={field.onChange} defaultValue={field.value} >
                                                <FormControl>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select" />
                            ...
                            {highClass ? (
                                <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex flex-row justify-center gap-4 items-center w-11/12">
                                                <FormLabel className="w-1/3 text-right">Examination</FormLabel>
                                                <FormControl className="w-2/3">
                                                    <Input type="text" {...field} />
                                                </FormControl>
                                                <FormMessage />
                            ...
                            <div className="w-11/12 z-0 relative p-8 my-6 m-auto  flex flex-col justify-center border border-gray-300 rounded-md">
                                <div className="w-[94%] z-10 absolute m-auto -top-2 bg-[#84B995] p-1 rounded-lg"><p className="text-white text-xs font-bold">Add Avatar</p></div>
