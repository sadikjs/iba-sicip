...
const EditRegister = ({ getUser, editId }) => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      dateOfBirth: format(new Date(getUser?.dateOfBirth), "yyyy-MM-dd"),
      ...
      sscInstitute: getUser?.sscInstitute,
      ...
      hscInstitute: getUser?.hscInstitute,
      ...
      experiedOrganizationAddressOne:
        getUser.experiedOrganizationAddressOne || "",
      experiedStartDateOne: getUser.experiedStartDateOne
        ? format(new Date(getUser.experiedStartDateOne), "yyyy-MM-dd")
        : null,
      experiedEndDateOne: getUser.experiedEndDateOne
        ? format(new Date(getUser.experiedEndDateOne), "yyyy-MM-dd")
        : null,
      ...
      experiedOrganizationAddressTwo:
        getUser.experiedOrganizationAddressTwo || "",
      experiedStartDateTwo: getUser.experiedStartDateTwo
        ? format(new Date(getUser.experiedStartDateTwo), "yyyy-MM-dd")
        : null,
      experiedEndDateTwo: getUser.experiedEndDateTwo
        ? format(new Date(getUser.experiedEndDateTwo), "yyyy-MM-dd")
        : null,
      ...
      experiedOrganizationAddressThree:
        getUser.experiedOrganizationAddressThree || "",
      experiedStartDateThree: getUser.experiedStartDateThree
        ? format(new Date(getUser.experiedStartDateThree), "yyyy-MM-dd")
        : null,
      experiedEndDateThree: getUser.experiedEndDateThree
        ? format(new Date(getUser.experiedEndDateThree), "yyyy-MM-dd")
        : null,
      ...
      experiedOrganizationAddressFour:
        getUser.experiedOrganizationAddressFour || "",
      experiedStartDateFour: getUser.experiedStartDateFour
        ? format(new Date(getUser.experiedStartDateFour), "yyyy-MM-dd")
        : null,
      experiedEndDateFour: getUser.experiedEndDateFour
        ? format(new Date(getUser.experiedEndDateFour), "yyyy-MM-dd")
        : null,
