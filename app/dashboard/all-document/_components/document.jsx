...
const Document = ({ allData }) => {
    ...
    const columns = [
        columnsHelper.accessor("serialNo", {
            ...
            header: () => (
                <span className="flex items-center">
                    <User className="mr-2" size={16} />SL
                </span>
            )
        }),
        columnsHelper.accessor("roll", {
            ...
            header: () => (
                <span className="flex items-center">
                    <User className="mr-2" size={16} />Roll
                </span>
            )
        }),
        ...
        columnsHelper.accessor("email", {
            ...
            header: () => (
                <span className="flex items-center">
                    <Mail className="mr-2" size={16} />E-mail
                </span>
            )
        }),
        ...
        columnsHelper.accessor("nid", {
            ...
            header: () => (
                <span className="flex items-center">
                    <Phone className="mr-2" size={16} />NID
                </span>
            )
        }),
    ...
    return (
        <div className={`${inter.className} w-full flex flex-col min-h-screen max-w-4xl mx-auto py-12 px-2 sm:px-6 lg:px-8`}>
                            ...
                            <tr key={headerGroup.id}>
                                {
                                    headerGroup.headers.map(header => (
                                        <th key={header.id} className="border border-gray-300 px-3 py-2">
                                            <div {...{
