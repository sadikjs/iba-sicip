...
const DownloadAttendance = ({ id }) => {
  ...
  return (
    <>
      <div
        id="pdfContent"
        className={`${inter.className} w-10/12 flex flex-col justify-center items-center`}
      >
        <button
          onClick={generatePdf}
        ...
        <h2 className="text-xl py-2 font-semibold">
          Center: Dr. Mahbubur Rahman Mollah College, Matuail, Jatrabari, Dhaka.
        </h2>
        <div className="flex flex-row justify-center items-center gap-2 py-2">
          ...
          <p>|</p>
          <div className="flex flex-row justify-center items-center">
            <p>Capacity:</p> <p>{data.capacity}</p>
          </div>
          <p>|</p>
          <div className="flex flex-row justify-center items-center">
            <p>Roll:</p>
            <p>
              {data.startRoll} <span>to</span>
              {data.startRoll}
            </p>
          </div>
        </div>
          ...
          <table className="py-2">
            <thead>
              <tr className="grid grid-cols-10 border border-gray-200">
                ...
                <th className="border-l col-span-1 border-gray-200 px-4 py-2 text-center">
                  Roll Number
                </th>
                <th className="border-l col-span-2 border-gray-200 px-4 py-2 text-center">
                  Photo
                </th>
                <th className="border-l col-span-3 border-gray-200 px-4 py-2 text-center">
                  Name
                </th>
                <th className="border-l col-span-3 border-gray-200 px-4 py-2 text-center text-center">
                  Signature
                </th>
              </tr>
            </thead>
            <tbody>
              {data.students.map((student) => (
                <tr
                  key={student.roll}
                  className="grid grid-cols-10 w-full h-20 border border-gray-200"
                >
                  <td className="col-span-1 h-20 border-r border-gray-200 flex justify-center items-center">
                    {nextId++}
                  </td>
                  <td className="col-span-1 h-20 border-r border-gray-200 flex justify-center items-center">
                    {student?.roll}
                  ...
                  <td className=" col-span-3 px-4 h-20 border-r border-gray-200 flex justify-center items-center">
                    {student?.name}
                  </td>
